...
<div class="container mt-5 mb-5">
	...
	<table border="1"  class="table"   >
		...
		<tr>
			<th>작성자</th>
			<td>${lecturereviewDto.memberId}</td>
		</tr>
		<tr>
			<th>만족도</th>
	...
	<div class="text-center">
		<a href="<c:url value="/review/delete/${lecturereviewDto.reviewId}"/>"  class="btn btn-dark mr-3">삭제</a>
		<a href="<c:url value="/review/edit/${lecturereviewDto.reviewId}"/>"  class="btn btn-dark mr-3">수정</a>
