...
<div class="container">
	...
	<div class="mt-4">
		...
		<br>
			...
			<hr>
			<ul class="list-group list-group-flush mt-2">
				<li class="list-group-item"><h4>가입 시간</h4></li>
	...
	<br><br>
	<div class="mt-4">
	<h1><strong>내가 구매한 강의 정보</strong></h1>
	<br><hr>
			...
			<c:forEach var="lectureImg" items="${myOrderLectureImg}" varStatus="Loop">
				<c:choose>
						...
						<div class="card mx-auto" style="width:700px;">
						  ...
						  <div class="card-body">
						    <h2 class="card-title"> 강의 제목 : ${lecture.lectureTitle} </h2>
						    <p class="card-text"> 강의 가격 :  ${lecture.lecturePrice} 원</p>
						    <a href="<c:url value='/lectureroom/list'/>" class="btn btn-primary btn-lg mx-auto">강의 게시판 가기</a>
						  </div>
						</div>
						<br><hr>
			 	   	</c:when>
