...
public class LectureReviewController {
	...
	public String write(Model model,HttpSession session) {
		...
		model.addAttribute("lecturereviewDto",new LectureReviewDto());
		return "/review/write";
	}
	
	//리뷰 등록
	@RequestMapping(value="/review/write",method=RequestMethod.POST)
	public String write(LectureReviewDto LectureReviewDto) {
	...
	public String delete (@PathVariable("reviewId")int reviewId) throws Exception{
